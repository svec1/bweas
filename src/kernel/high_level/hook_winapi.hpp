...
#define HOOK_TEXT_DETECTED "WARNING!!!A winapi call was detected, most likely the dynamically loaded dll library is hostile.\n"
#define HOOK_TEXT_WARNING HOOK_TEXT_DETECTED"INFO: "

#define hook_handleExW(info, size_info) \
    SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 4); \
    realWriteConsoleW(GetStdHandle(STD_OUTPUT_HANDLE), (HOOK_TEXT_WARNING), \
        149, NULL, NULL); \
...
#define hook_handleExA(info, size_info) \
    SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 4); \
    realWriteConsoleA(GetStdHandle(STD_OUTPUT_HANDLE), (HOOK_TEXT_WARNING), \
        149, NULL, NULL); \

...
class semantic_analyzer {
  ...
  private:
    u32t convert_id_literal(aef_expr::subexpressions &sub_expr, var::scope &curr_scope, aef_expr::params expected_param);
    ...
    void parse_keyword_op_param(aef_expr::subexpressions &sub_expr, u32t pos_token_kw_in_subexpr, 

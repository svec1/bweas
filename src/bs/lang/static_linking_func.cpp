...
sl_func::flags_compiler(const std::vector<subexpressions> &sub_expr, var::scope &curr_scope) {
    ...
    if ((var::struct_sb::configuration)std::stoi(sub_expr[1].token_of_subexpr[0].token_val.c_str()) ==
    ...
    if (curr_scope.what_type(sub_expr[0].token_of_subexpr[0].token_val) != 5)
        throw interpreter::realtime_excp(
            parser::build_pos_tokenb_str(sub_expr[0].token_of_subexpr[0]) +
                " Var id of struct(expected project): " + sub_expr[0].token_of_subexpr[0].token_val + "\n",
            "003");
    curr_scope.get_var_value<var::struct_sb::project>(sub_expr[0].token_of_subexpr[0].token_val).path_compiler =
        sub_expr[1].token_of_subexpr[0].token_val;
}
void
    ...
    if (curr_scope.what_type(sub_expr[0].token_of_subexpr[0].token_val) != 5)
        throw interpreter::realtime_excp(
            parser::build_pos_tokenb_str(sub_expr[0].token_of_subexpr[0]) +
                " Var id of struct(expected project): " + sub_expr[0].token_of_subexpr[0].token_val + "\n",
            "003");
    curr_scope.get_var_value<var::struct_sb::project>(sub_expr[0].token_of_subexpr[0].token_val).path_linker =
        sub_expr[1].token_of_subexpr[0].token_val;
}
void
    ...
    if (curr_scope.what_type(sub_expr[0].token_of_subexpr[0].token_val) != 5)
        throw interpreter::realtime_excp(
            parser::build_pos_tokenb_str(sub_expr[0].token_of_subexpr[0]) +
                " Var id of struct(expected project): " + sub_expr[0].token_of_subexpr[0].token_val + "\n",
            "003");
    curr_scope.get_var_value<var::struct_sb::project>(sub_expr[0].token_of_subexpr[0].token_val).standart_c =
        std::stoi(sub_expr[1].token_of_subexpr[0].token_val.c_str());
}
void
    ...
    if (curr_scope.what_type(sub_expr[0].token_of_subexpr[0].token_val) != 5)
        throw interpreter::realtime_excp(
            parser::build_pos_tokenb_str(sub_expr[0].token_of_subexpr[0]) +
                " Var id of struct(expected project): " + sub_expr[0].token_of_subexpr[0].token_val + "\n",
            "003");
    curr_scope.get_var_value<var::struct_sb::project>(sub_expr[0].token_of_subexpr[0].token_val).standart_cpp =
        std::stoi(sub_expr[1].token_of_subexpr[0].token_val.c_str());
}
void
    ...
    if (curr_scope.what_type(sub_expr[0].token_of_subexpr[0].token_val) != 5)
        throw interpreter::realtime_excp(
            parser::build_pos_tokenb_str(sub_expr[0].token_of_subexpr[0]) +
                " Var id of struct(expected project): " + sub_expr[0].token_of_subexpr[0].token_val + "\n",
            "003");
    curr_scope.get_var_value<var::struct_sb::project>(sub_expr[0].token_of_subexpr[0].token_val).lang =
        (var::struct_sb::language)std::stoi(sub_expr[1].token_of_subexpr[0].token_val);
}
...
sl_func::use_it_template(const std::vector<subexpressions> &sub_expr, var::scope &curr_scope) {
    ...
    curr_scope.get_var_value<var::struct_sb::project>(sub_expr[0].token_of_subexpr[0].token_val).use_it_templates =
        std::stoi(sub_expr[1].token_of_subexpr[0].token_val);
}